...
const SITE_TITLE = "美股成交值排行 Top 50";
const SITE_DESC =
  "全美股市場依成交金額（價格 × 成交量）排序的每日排行榜，含 AI 題材／族群分析、今日市場焦點、新進榜雷達與個股走勢。";
...
export const metadata: Metadata = {
  // 給網域即可；上方 OG_IMAGE 已含 basePath。
  metadataBase: new URL("https://usstocktop50.github.io"),
  title: SITE_TITLE,
  description: SITE_DESC,
  keywords: ["美股", "成交值", "成交金額", "排行榜", "Top 50", "題材", "族群", "US stocks", "dollar volume"],
  openGraph: {
    type: "website",
    locale: "zh_TW",
    siteName: SITE_TITLE,
